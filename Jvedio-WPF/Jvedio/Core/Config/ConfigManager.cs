...
namespace Jvedio
{
    public static class ConfigManager
    {
        ...
        public static TaskParallelismConfig TaskParallelism { get; set; }
        public static Jvedio.Core.Config.HttpMetadataConfig HttpMetadata { get; set; }
        ...
        private static void CreateInstance()
        {
            ...
            TaskParallelism = TaskParallelismConfig.CreateInstance();
            HttpMetadata = Jvedio.Core.Config.HttpMetadataConfig.CreateInstance();
        ...
        public static void Init(Action onLoaded)
        {
            ...
            Init();
            Jvedio.Core.Metadata.HttpMetadataOptions.SyncFromConfig(HttpMetadata);
