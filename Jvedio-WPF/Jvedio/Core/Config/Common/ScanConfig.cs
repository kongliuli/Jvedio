...
namespace Jvedio.Core.Config
{
    public class ScanConfig : AbstractConfig
    {
        ...
        private ScanConfig() : base("ScanConfig")
        {
            ...
            ScrapeAfterScan = true;
            ScanNfo = true;

            UseParallelDiscovery = false;
            DiscoveryThreadCount = 0;
            EnableDirIndexCache = true;
        }
        ...
        public bool ScrapeAfterScan { get; set; }
        ...
        public bool UseParallelDiscovery { get; set; }
        public int DiscoveryThreadCount { get; set; }
        public bool EnableDirIndexCache { get; set; }
    }
}
