        ...
        public static class AppData
        {
            ...
            static AppData()
            {
                ...
                TABLES.Add("common_picture_exist",
                    ...
                    "COMMIT;");
                TABLES.Add("scan_dir_index",
                    "BEGIN; " +
                    "create table scan_dir_index ( " +
                        "IndexId INTEGER PRIMARY KEY autoincrement, " +
                        "DbId INTEGER NOT NULL, " +
                        "DirPath TEXT NOT NULL, " +
                        "MtimeUtcTicks INTEGER NOT NULL, " +
                        "EntryCount INTEGER NOT NULL, " +
                        "ChildrenChecksum TEXT NOT NULL, " +
                        "LastScanUtc TEXT NOT NULL, " +
                        "unique(DbId, DirPath) " +
                    "); " +
                    "CREATE INDEX scan_dir_index_idx_DbId ON scan_dir_index (DbId); " +
                    "COMMIT;");
                TABLES.Add("metadata_lookup_cache",
                    "BEGIN; " +
                    ...
                    "); " +
                    "CREATE INDEX metadata_lookup_cache_idx_ExpiresUtc ON metadata_lookup_cache (ExpiresUtc); " +
                    "COMMIT;");
            }
        }
