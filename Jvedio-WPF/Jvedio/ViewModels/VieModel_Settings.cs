...
namespace Jvedio.ViewModel
{
    public class VieModel_Settings : ViewModelBase
    {
        ...
        private bool _UseParallelDiscovery = ConfigManager.ScanConfig.UseParallelDiscovery;

        public bool UseParallelDiscovery {
            get { return _UseParallelDiscovery; }
            set {
                _UseParallelDiscovery = value;
                RaisePropertyChanged();
            }
        }

        private int _DiscoveryThreadCount = ConfigManager.ScanConfig.DiscoveryThreadCount;

        public int DiscoveryThreadCount {
            get { return _DiscoveryThreadCount; }
            set {
                _DiscoveryThreadCount = value;
                RaisePropertyChanged();
            }
        }

        private bool _EnableDirIndexCache = ConfigManager.ScanConfig.EnableDirIndexCache;

        public bool EnableDirIndexCache {
            get { return _EnableDirIndexCache; }
            set {
                _EnableDirIndexCache = value;
                RaisePropertyChanged();
            }
        }
